          ...
          children: <Widget>[
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment
                  .spaceBetween, // Align buttons to opposing sides
              children: [
                StyledButton(
                  text: 'Add',
            ...
            if (_noteController
                .text
                .isNotEmpty) // Display the note if it's not empty
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(
...
class StyledButton extends StatelessWidget {
  ...
  final VoidCallback onPressed; // Callback function when the button is clicked
